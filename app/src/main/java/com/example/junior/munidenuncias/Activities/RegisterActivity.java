...
import com.example.junior.munidenuncias.Network.ResponseMessage;
...
public class RegisterActivity extends AppCompatActivity {
    ...
    private EditText usuarios_id_Input;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        usuarios_id_Input = (EditText) findViewById(R.id.usuarios_id_input);
    }
    ...
    public void callRegister(View view) {
        ...
        String latitud = "";
        String longitud = "";
        String usuarios_id = usuarios_id_Input.getText().toString();
        ...
        if (mediaFileUri == null) {
            // Si no se incluye imagen hacemos un envÌo POST simple
            call = service.createDenuncia(titulo, descripcion, usuarios_id);
        } else {
            // Si se incluye hacemos enviÛ en multiparts

            File file = new File(mediaFileUri.getPath());
            Log.d(TAG, "File: " + file.getPath() + " - exists: " + file.exists());

            // Podemos enviar la imagen con el tamaÒo original, pero lo mejor ser· comprimila antes de subir (byteArray)
            ...
            call = service.createDenunciaWithImage(tituloPart, descripcionPart, imagenPart,usuarios_idPart);
        }
